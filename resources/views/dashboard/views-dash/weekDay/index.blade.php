...
@section('content')
                ...
                <div class="modal-body">
                    ...
                    <form id="formWeekDayAdd" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" id="addWeekDay">{{ __('Save') }}</button>
    ...
    <!-- End Basic modal -->
    <div class="modal" id="modalWeekDayUpdate">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form id="formWeekDayUpdate" enctype="multipart/form-data">
                        @method('PUT')
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success"
                                id="updateWeekDay">{{ __('Update') }}</button>
    ...
    <div class="modal" id="modalWeekDayDelete" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-secondary" data-bs-dismiss="modal"
                        type="button">{{ __('Close') }}</button>
                    <button type="submit" class="btn btn-danger" id="deleteWeekDay">{{ __('Delete') }}</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="row row-xs wd-xl-80p">
                        <div class="col-sm-6 col-md-3 mg-t-10">
                            <button class="btn btn-info-gradient btn-block" id="ShowModalWeekDay"
                ...
                <div class="card-body">
                    <div class="table-responsive hoverable-table">
                        <table class="table table-hover" id="get_weekDay" style=" text-align: center;">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script src="{{ asset('dashboard/local/weekdays.js') }}"></script>
@stop
